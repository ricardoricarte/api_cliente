...
import com.algaworks.algalog.domain.services.CatalagoClienteService;
...
public class ClienteController {
  ...
  public ResponseEntity<Cliente> atualizarClientes(@Valid @PathVariable Long clienteId, @RequestBody Cliente cliente) {
  ...
  public ResponseEntity<Void> excluirClientes(@PathVariable Long clienteId) {
    if (!clienteRepository.existsById(clienteId)) {
      return ResponseEntity.notFound().build();
    }
